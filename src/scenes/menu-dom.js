...
function pauseOverlayMarkup() {
  return `<div id="pauseScreen" class="ds-screen ds-screen--overlay scene-pause-overlay" data-menu-page="main" data-menu-direction="forward">
    <div class="menu-card ds-panel"><div class="eyebrow ds-overline" id="menuEyebrow">Paused</div><h2 id="menuTitle" class="ds-title">Paused</h2><div id="menuPages" class="menu-pages">
      ...
      <div id="settingsHubPage" class="menu-page settings-layout scene-settings-overlay" data-page="settings"><p>Tune how the game feels before jumping in.</p><button id="settingsBackButton" type="button" class="settings-back-button ds-button ds-button--secondary" data-settings-back="root">Back</button><div id="settingsRootRows" class="settings-root-rows"></div><div id="settingsCategoryList" class="settings-category-list" aria-label="Settings categories"></div></div>
      <div id="settingsCategoryPage" class="menu-page settings-layout scene-settings-overlay" data-page="settings-category"><p id="settingsCategoryDescription">Adjust settings.</p><button id="settingsCategoryBackButton" type="button" class="settings-back-button ds-button ds-button--secondary" data-settings-back="category">Back</button><div id="settingsStatus" class="status-line" aria-live="polite"></div><div id="settingsCategoryBody" class="settings-category-body"></div></div>
