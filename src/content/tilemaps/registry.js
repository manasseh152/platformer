...
import { act01Level5 } from './definitions/act-01-level-5.js';
import { act01Level6 } from './definitions/act-01-level-6.js';
...
export const act01Level5Tilemap = registry.register(act01Level5);
export const act01Level6Tilemap = registry.register(act01Level6);
